---
title: Exports to the National Metadata Directory
---

This document is intended for administrators of repositories in the
National Repository Platform who need to export metadata to the [National Metadata Directory (NMD)/Národní metadatový adresář (NMA)](https://nma.eosc.cz/).
